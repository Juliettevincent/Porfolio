...
<head>
    ...
    <title>Projet Halloween</title>
    <link rel="stylesheet" href="css/halloween.css">
    <div class="logo">
    <a href="index.php"><img src="images/logo.png" alt="Logo" height="80"></a>
    </div>
</head>
<body>
    <h1>Réalisation d'un projet interactif pour l'Halloween. </h1>
    <div class="gallerie">
    ...
    <p>Le projet consistait d'une scène Unity 3d projetée sur un mur.
        ...
        le départ de la soirée.
    </p>
    <div><img src="../images/halloweenEnDeveloppement.jpg" width="300" height="auto"></img></div>
    </div>
    <div class="gallerie-below">
    <div><img src="../images/snapshot_1.png" width="420" height="auto"></img></div>
    <div><img src="../images/snapshot_4.png" width="420" height="auto"></img></div>
    </div>
</body>
</html>
